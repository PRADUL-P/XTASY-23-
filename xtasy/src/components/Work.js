      ...
      <div className="container mx-auto">
        <div className='flex flex-col lg:flex-row gap-x-10'>
          <motion.div
            ...
            <div >
              <h2 className='h2 leading-tight text-accent'>previous xtacy</h2>
          ...
          <motion.div
            ...
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              group-hover:bottom-14 transition-all duration-700 z-50'>
                <span className='text-3xl text-white'>2K22</span>
              </div>
              <div className='absolute -bottom-full right-12 
              group-hover:bottom-14 transition-all duration-700 z-50'>
                <a href="https://youtu.be/zNm09qkTNP4" className="text-gradient btn-link" target="_blank">
                  view
                </a>
              </div>
            </div>
            <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
              ...
              <div className='absolute -bottom-full left-12 
              group-hover:bottom-14 transition-all duration-700 z-50'>
                <span className='text-3xl text-white'>2K19</span>
              </div>
              <div className='absolute -bottom-full right-12 
              group-hover:bottom-14 transition-all duration-700 z-50'>
                <a href="https://youtu.be/QIETwmA-n1Q" className="text-gradient btn-link" target="_blank">
                  view
                </a>
              </div>
            </div>
