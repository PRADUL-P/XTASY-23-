        ...
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center">
          ...
          font-semibold uppercase leading-[1]"
            ...
            <motion.div
              ...
              <a href="https://www.linkedin.com/company/st-thomas-college-of-engineering-technology-sivapuram-kannur/">
                <FaLinkedin />
              </a>
          ...
          <motion.div
            ...
            whileInView={'show'}
            viewport={{ once: false, amount: 0.7 }}
            className="hidden  lg:flex flex-1 max-w-[400px] lg:max-w-[335px]">
